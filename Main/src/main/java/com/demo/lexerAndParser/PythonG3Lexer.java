...
public class PythonG3Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TRUE", "FALSE", "NULL", "IF", "ELSE", "ELSE_IF", "FOR", "WHILE", "CONTINUE", 
			"BREAK", "CONST_AND", "CONST_OR", "NEGATION", "IN", "PLUS", "MINUS", 
			"MULTIPLICATION", "DIVISION", "MODULO", "EQUALITY", "INEQUALITY", "GREATER", 
			"GREATER_OR_EQUAL", "SMALLER", "SMALLER_OR_EQUAL", "ASSIGNMENT", "LEFT_PARENTHESIS", 
			"RIGHT_PARENTHESIS", "COLON", "INCREASE_ADD", "DECREASE_SUBSTRACT", "INCREASE_MULTIPLY", 
			"DECREASE_DIVISION", "DECREASE_MODULO", "LEFT_BRACKET", "RIGHT_BRACKET", 
			"SEPARATOR", "LEFT_CURLY", "RIGHT_CURLY", "STRING", "STRING_LITERAL", 
			"NEWLINE", "SPACES", "INT", "FLOAT", "VARIABLE", "WS", "INCORECT_CHAR", 
			"DIGIT", "WHITESPACE", "LETTER", "COMMENT", "SHORT_STRING", "LONG_STRING", 
	...
	public PythonG3Lexer(CharStream input) {
		super(input);
